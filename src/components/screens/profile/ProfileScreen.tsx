...
export function ProfileScreen() {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.card}>
        <View style={styles.cardHeader}>
          ...
          <Button 
            variant="outline" 
            size="small"
            onPress={() => {/* TODO: Implement edit skill level */}}
          >
            Edit
          </Button>
        </View>
      ...
      {/* Upcoming Games Card */}
      <View style={styles.card}>
        <ThemedText variant="subtitle" style={styles.cardTitle}>Upcoming Games</ThemedText>
              ...
              <View style={styles.gameDetails}>
                <View style={styles.gameDetailRow}>
                  ...
                  <ThemedText variant="caption" style={styles.gameDetailText}>
                    {typeof game.location === 'string' ? game.location : 'Location not specified'}
                  </ThemedText>
                </View>
                <View style={styles.gameDetailRow}>
