    ...
    <ScrollView>
      <ThemedView style={styles.container}>
        ...
        <View style={styles.buttonContainer}>
          <Button onPress={testValidProfile}>Test Valid Profile</Button>

          <Button onPress={testInvalidProfile}>Test Invalid Profile</Button>

          <Button onPress={testProfileUpdate}>Test Profile Update</Button>
        </View>
        ...
        <ThemedView style={styles.results}>
          ...
          {validationResults.map((result, index) => (
            <ThemedText key={`${result}-${index}`} style={styles.resultText}>
              {result}
            </ThemedText>
          ))}
        </ThemedView>
