...
describe("TextInput", () => {
  ...
  it("displays error message with proper accessibility", () => {
    const { getByText, getByTestId } = render(
      <TextInput label="Password" error="Password is required" />,
    );
  ...
  it("handles disabled state correctly", () => {
    const { getByTestId } = render(
      <TextInput label="Username" editable={false} />,
    );
  ...
  it("handles start icon correctly", () => {
    const { getByTestId } = render(
      <TextInput label="Search" startIcon={<View testID="start-icon" />} />,
    );
  ...
  it("handles end icon without press handler correctly", () => {
    const { getByTestId } = render(
      <TextInput label="Password" endIcon={<View testID="end-icon" />} />,
    );
  ...
  it("associates label with input using accessibilityLabel", () => {
    const { getByText, getByTestId } = render(<TextInput label="Username" />);
  ...
  it("associates helper/error text with input using accessibilityHint", () => {
    const { getByTestId, rerender } = render(
      <TextInput label="Username" helperText="Enter your username" />,
    );
    ...
    // Test with error
    rerender(<TextInput label="Username" error="Username is required" />);
  ...
  it("forwards ref correctly", () => {
    ...
    const { getByTestId } = render(<TextInput ref={ref} label="Username" />);
