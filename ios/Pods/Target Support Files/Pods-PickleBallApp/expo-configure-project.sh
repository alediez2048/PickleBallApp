...
with_node \
  ...
  --target "/Users/jorgealejandrodiez/Desktop/PickleBallApp/ios/Pods/Target Support Files/Pods-PickleBallApp/ExpoModulesProvider.swift" \
  --entitlement "/Users/jorgealejandrodiez/Desktop/PickleBallApp/ios/PickleBallApp/PickleBallApp.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-crypto" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-image-picker" "expo-keep-awake" "expo-linking" "expo-location" "expo-router" "expo-secure-store" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
